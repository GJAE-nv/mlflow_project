...
if __name__ == "__main__":
    ...
    with mlflow.start_run():
        ...
        mlflow.sklearn.log_model(lr, "model") #,  conda_env='/Users/gertjan.vanlook/Documents/ml-flow-test/project_test/conda.yaml')
        mlflow.log_artifact('/Users/gertjan.vanlook/Desktop/main_project/project-folder/Houses_Model.py', 'py_file_model') 
